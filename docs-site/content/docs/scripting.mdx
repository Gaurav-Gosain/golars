---
title: "golars scripting language (.glr)"
description: ".glr files are a tiny, line-oriented language for pipeline-style DataFrame work. Every REPL command is a script statement."
icon: FileText
---
